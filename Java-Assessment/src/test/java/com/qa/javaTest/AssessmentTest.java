...
public class AssessmentTest {
	...
	public void nMidTest() {
		assertTrue(oe.nMid("Hello", 1).equals("ho"));
		assertEquals("ell", oe.nMid("Hello", 3));
	...
	public void largestTest() {
		assertTrue("Are you returning the right thing?", oe.largest("55 72 86") == -1);
		assertEquals(14,oe.largest("55 72 86"));
		assertEquals(11,oe.largest("15 72 80 164"));
		assertEquals(15,oe.largest("10 45 72 86 555"));
